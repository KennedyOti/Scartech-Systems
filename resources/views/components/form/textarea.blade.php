...
<div>
    ...
    <textarea
        ...
        {{ $attributes->class([
            'mt-2 block w-full rounded-md border bg-white px-3.5 py-3 text-base text-slate-900 placeholder:text-slate-400 transition-colors duration-[120ms] focus:outline-2 focus:outline-offset-0 focus:outline-brand-600',
            'border-danger' => $error,
